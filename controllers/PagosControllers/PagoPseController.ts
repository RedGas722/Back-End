...
export const generarPagoPSE = async (req: Request, res: Response) => {
    try {
        ...
        const pseData = {
            bank, invoice, description: "Compra RedGas", value, tax: '0', tax_base: '0',
            currency: 'COP', type_person, doc_type, doc_number, name, last_name: "N/A",
            email, country: 'CO', cell_phone: telefono, url_response: 'https://redgas-one.vercel.app/Shopping/ConfirmacionPsE',
            url_confirmation: 'https://redgas.onrender.com/ConfirmacionPagoPSE',
            method_confirmation: 'POST', extra1: direccion
        };
